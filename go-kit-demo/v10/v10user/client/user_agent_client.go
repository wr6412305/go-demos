...
// UserAgentClient ...
func (u *UserAgent) UserAgentClient() (v10service.Service, error) {
	var (
		retryMax     = 3
		retryTimeout = 500 * time.Millisecond
	)
	var endpoints v10endpoint.EndPointServer
	{
		factory := u.factoryFor(v10endpoint.MakeLoginEndPoint)
...
func (u *UserAgent) factoryFor(makeEndpoint func(v10service.Service) endpoint.Endpoint) sd.Factory {
...
// NewGRPCClient ...
func (u *UserAgent) NewGRPCClient(conn *grpc.ClientConn) v10service.Service {
	options := []grpctransport.ClientOption{
		grpctransport.ClientBefore(func(ctx context.Context, md *metadata.MD) context.Context {
			...
			md.Set(v10service.ContextReqUUID, UUID)
	...
	return v10endpoint.EndPointServer{
