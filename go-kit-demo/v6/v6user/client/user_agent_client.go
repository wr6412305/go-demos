...
// UserAgentClient ...
func (u *UserAgent) UserAgentClient() (v6service.Service, error) {
	var (
		retryMax     = 3
		retryTimeout = 500 * time.Millisecond
	)
	var endpoints v6endpoint.EndPointServer
	{
		factory := u.factoryFor(v6endpoint.MakeLoginEndPoint)
...
func (u *UserAgent) factoryFor(makeEndpoint func(v6service.Service) endpoint.Endpoint) sd.Factory {
...
// NewGRPCClient ...
func (u *UserAgent) NewGRPCClient(conn *grpc.ClientConn) v6service.Service {
	options := []grpctransport.ClientOption{
		grpctransport.ClientBefore(func(ctx context.Context, md *metadata.MD) context.Context {
			...
			md.Set(v6service.ContextReqUUID, UUID)
	...
	return v6endpoint.EndPointServer{
