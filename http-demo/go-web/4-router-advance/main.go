...
func main() {
	...
	// curl -X POST "http://127.0.0.1:8080/posts/create"
	// curl -X PUT "http://127.0.0.1:8080/posts/update"
	// curl -X DELETE "http://127.0.0.1:8080/posts/delete"
	// curl "http://127.0.0.1:8080/posts/show"
	// 路由分组(基于子路由+路径前缀)
